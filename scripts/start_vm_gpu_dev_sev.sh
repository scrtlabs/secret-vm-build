...
ROOTFS_HASH=$(sha256sum $ARTIFACTS_DIR/sev/rootfs-gpu-dev.iso | cut -f1 -d' ')
...
qemu-system-x86_64 -D ${VM_NAME}.log \
                   ...
                   -drive file=$ARTIFACTS_DIR/sev/rootfs-gpu-dev.iso,if=none,id=cdrom0,format=raw,media=cdrom,readonly=on \
